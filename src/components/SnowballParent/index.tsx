...
export const SnowballParent = () => {
  ...
  useEffect(() => {
    ...
    tempLoanList.sort((objA: ILoan, objB: ILoan) => {
      return objA.principal - objB.principal;
    });
  ...
  const getOneMonthBreakdown = (
    ...
    tempLoanList.forEach((element, index) => {
      ...
      //console.log(excessFromMonthlyPayment);
  ...
  return (
    <div>
      {context !== null && context.listLoans !== null ? (
        <div className="SnowballParentDiv">
          <SubHeaderGeneric
            title="Snowball"
            description="Pay down loans by the smallest principal amount"
          />
